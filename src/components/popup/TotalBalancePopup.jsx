...
export default function TotalBalancePopup({ isOpen, onClose, onSave, currentDate, lastSavedData }) {
  ...
  const handleSubmit = (e) => {
    ...
    Object.keys(balanceData).forEach((key) => {
      if (key === "note") {
        formattedData[key] = balanceData.note;
      } else {
        ...
        if (val === "" || val === null || val === undefined) {
          ...
          try {
            const sanitizedExpr = String(val)
              .replace(/\./g, "")
              .replace(/[^0-9+\-*/.]/g, "");
          ...
          >
            ...
            <div className="form-group">
              ...
              <input
                type="text"
                name="kassenfrisch"
                value={balanceData.kassenfrisch}
                onChange={handleChange}
                placeholder={placeholders.kassenfrisch}
              />
            </div>
            ...
            <div className="form-group">
              ...
              <textarea name="note" value={balanceData.note} onChange={handleChange} placeholder="Nhập ghi chú (nếu có)..." rows="3" />
            </div>
          </div>
