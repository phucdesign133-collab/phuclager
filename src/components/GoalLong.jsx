...
export default function GoalLong({ rawData, onEdit, onDelete }) {
  if (!rawData || rawData.length === 0) {
    return (
      <div className="grid-no-data">
        Chưa có mục tiêu dài hạn nào được thiết lập. Hãy bấm nút "Cập nhật" để thêm mới!
      </div>
    );
  }
